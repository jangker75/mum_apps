<?php namespace App\Http\Controllers;
	...
	class AdminClientController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Nama Client","name"=>"nama"];
			$this->col[] = ["label"=>"Nomor ID Client","name"=>"nomor_id"];
			...
			$this->form[] = ['label'=>'Nomor ID Client','name'=>'nomor_id','type'=>'text','validation'=>'required|string|min:0','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Provinsi','name'=>'provinsi_id','type'=>'select2','validation'=>'required|integer|min:0','datatable'=>'provinsi,nama','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Kota','name'=>'kota_id','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'kota,nama','parent_select'=>'provinsi_id'];
			...
			//$this->form[] = ["label"=>"Nomor Id","name"=>"nomor_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"nomor,id"];
