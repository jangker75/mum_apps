<?php namespace App\Http\Controllers;
	...
	class AdminNewsContentController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Creator","name"=>"creator"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Creator','name'=>'creator','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Isi','name'=>'isi','type'=>'wysiwyg','validation'=>'required|string|min:5|max:500000','width'=>'col-sm-10'];
