<?php namespace App\Http\Controllers;
	...
	class AdminUserTenantController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Nama Tenant","name"=>"id_tenant","join"=>"tenant,nama"];
			$this->col[] = ["label"=>"Alamat Tenant","name"=>"id_tenant","join"=>"tenant,alamat"];
			$this->col[] = ["label"=>"Nama User","name"=>"nama"];
			$this->col[] = ["label"=>"Username","name"=>"username"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Nama Tenant','name'=>'id_tenant','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'tenant,nama'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Lokasi","name"=>"id_lokasi","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"lokasi,id"];
