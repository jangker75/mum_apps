...
<ul class="nav nav-tabs">
        ...
        <li class='active'><a href="<?php echo e(CRUDBooster::mainpath('generator')); ?>"><i class='fa fa-cog'></i> API Generator</a></li>        
      </ul>
        ...
        $(document).on('click','.tr-response',function() {
          ...
          if(is_check == '1') {
            ...
            function load_response() {                  
                  ...
                  no_params = 0;
                  $.get('<?php echo e(url(config("crudbooster.ADMIN_PATH"))."/api_generator/column-table"); ?>/'+t+'/'+type,function(resp) {                                                                          
            ...
            function init_data_responses() {
              <?php if($responses): ?>
                ...
                no_params = 0;
                var responses_data = <?php echo $responses; ?>;
    ...
    <?php $__env->stopPush(); ?>
                ...
                <form method='post' action='<?php echo e(route("ApiCustomControllerPostSaveApiCustom")); ?>'>
                  ...
                  <input type="hidden" name="id" value="<?php echo e($row->id); ?>">
                        <div class='row'>
                          <div class='col-sm-8'>
                            <div class='form-group'>                          
                                ...
                                <input type='text' class='form-control' value='<?php echo e($row->nama); ?>' required name='nama' id='input-nama'/>
                            </div>
                          </div>
                          ...
                          <div class='col-sm-4'>
                            <div class='form-group'>
                                ...
                                <select id='combo_tabel' name='tabel' required class='form-control'>
                                      ...
                                      <?php $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <option <?php echo e(($row->tabel == $tab)?"selected":""); ?> value='<?php echo e($tab); ?>'><?php echo e($tab); ?></option>
                          ...
                          <div class='col-sm-8'>
                            <div class='form-group'>                            
                                ...
                                <div class='input-group'>
                                    <span class="input-group-addon" id="basic-addon1" style="background:#eeeeee"><?php echo e(url("api")); ?>/</span>
                                    <input type='text' class='form-control' value='<?php echo e($row->permalink); ?>' required name='permalink' id='input-permalink'/>
                                </div>                                
                            </div>
                          </div>
                          <div class='col-sm-2'>
                            <div class='form-group'>
                                ...
                                <select id='tipe_action' name='aksi' required class='form-control'> 
                                    ...
                                    <option value='list' <?php echo e(($row->aksi == 'list')?"selected":""); ?> >LISTING</option>
                                    <option value='detail' <?php echo e(($row->aksi == 'detail')?"selected":""); ?>>DETAIL / READ</option>
                                    <option value='save_add' <?php echo e(($row->aksi == 'save_add')?"selected":""); ?>>CREATE / ADD</option>
                                    <option value='save_edit' <?php echo e(($row->aksi == 'save_edit')?"selected":""); ?>>UPDATE</option>                                
                                    <option value='delete' <?php echo e(($row->aksi == 'delete')?"selected":""); ?>>DELETE</option>
                                </select>
                            </div>
                          </div>
                          <div class='col-sm-2'>
                            <div class='form-group'>
                                ...
                                <label class='radio-inline'>
                                    <input type='radio' required class='method_type' <?php echo e(($row->method_type == 'get')?"checked":""); ?> name='method_type' value='get'/> GET
                                </label>
                                <label class='radio-inline'>
                                    <input type='radio' class='method_type' <?php echo e(($row->method_type == 'post')?"checked":""); ?> name='method_type' value='post'/> POST
                                </label>
                        ...
                        <div class='form-group'>
                            ...
                            <textarea name='sql_where' rows='3' class='form-control' placeholder="status = [paramStatus]"><?php echo e($row->sql_where); ?></textarea>
                                ...
                                <table id='table-response' class='table table-striped table-bordered'>
                                  ...
                                  <tfoot style="display:none">
                                      <tr class='tr-additional'>
                                        <td>#</td>
                                        <td width="20%"><input placeholder='E.g : grand_total' name='responses_name[]' class='form-control' type='text'/><small>Enter alias name</small></td>     
                                        <td>
                                        ...
                                        <td><select class='form-control responses_used' name='responses_used[]'><option value='1'>YES</option><option value='0'>NO</option></select></td>
                                        <td class='col-delete'><a class='btn btn-primary' href='javascript:void(0)' onclick='addResponse()'><i class='fa fa-plus'></i></a></td>
                                      </tr>
                                  </tfoot>
                                </table>
                            </div>
                        ...
                        <div class='form-group'>
                            ...
                            <textarea name='keterangan' rows='3' class='form-control wysiwyg' placeholder='Optional'><?php echo e($row->keterangan); ?></textarea>
                        </div>
