...
<div class="container">
      <div class="page-header">
        <h1>API Documentation <?php echo e(Session::get('appname')); ?></h1>
      </div>
              ...
              <thead>
                  <tr class='info'><th width='2%'>No</th><th>API Name
                    <span class='pull-right'>
                      <a class='btn btn-xs btn-warning' target="_blank" href='<?php echo e(url("download-documentation-postman")); ?>'>Export For POSTMAN <sup>Beta</sup></a>
                    </span>
                  </th></tr>
              </thead> 
              <tbody>
  ...
  <hr>
  <div align="center">
      &copy; Copyright <?php echo e(date('Y')); ?>. All Right Reserved. API Documentation
  </div>
