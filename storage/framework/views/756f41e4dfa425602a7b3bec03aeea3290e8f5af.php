                    ...
                    <ul class='draggable-menu draggable-menu-active'>
                      ...
                      <?php 
                       ...
                       ?>
                        ...
                        <i class='<?php echo e(($menu->is_dashboard)?"icon-is-dashboard fa fa-dashboard":$menu->icon); ?>'></i> <?php echo e($menu->name); ?> <span class='pull-right'><a class='fa fa-pencil' title='Edit' href='<?php echo e(route("MenusControllerGetEdit",["id"=>$menu->id])); ?>?return_url=<?php echo e(urlencode(Request::fullUrl())); ?>'></a>&nbsp;&nbsp;<a title='Delete' class='fa fa-trash' onclick='<?php echo e(CRUDBooster::deleteConfirm(route("MenusControllerGetDelete",["id"=>$menu->id]))); ?>' href='javascript:void(0)'></a></span>
                        <br/><em class="text-muted"><small><i class="fa fa-users"></i> &nbsp; <?php echo e(implode(', ',$privileges)); ?></small></em>
                        </div>
                          <ul>
                            <?php if($menu->children): ?>
                              ...
                              <?php 
                               ...
                               ?>
                                ...
                                <div class='<?php echo e($child->is_dashboard?"is-dashboard":""); ?>' title="<?php echo e($child->is_dashboard?'This is setted as Dashboard':''); ?>"><i class='<?php echo e(($child->is_dashboard)?"icon-is-dashboard fa fa-dashboard":$child->icon); ?>'></i> <?php echo e($child->name); ?> <span class='pull-right'><a class='fa fa-pencil' title='Edit' href='<?php echo e(route("MenusControllerGetEdit",["id"=>$child->id])); ?>?return_url=<?php echo e(urlencode(Request::fullUrl())); ?>'></a>&nbsp;&nbsp;<a title="Delete" class='fa fa-trash' onclick='<?php echo e(CRUDBooster::deleteConfirm(route("MenusControllerGetDelete",["id"=>$child->id]))); ?>' href='javascript:void(0)'></a></span>
                                <br/><em class="text-muted"><small><i class="fa fa-users"></i> &nbsp; <?php echo e(implode(', ',$privileges)); ?></small></em>
                                </div></li>
                  ...
                  <div class="panel-body clearfix">
                    <ul class='draggable-menu draggable-menu-inactive'>
                       <?php $__currentLoopData = $menu_inactive; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li data-id='<?php echo e($menu->id); ?>' data-name='<?php echo e($menu->name); ?>'><div><i class='<?php echo e($menu->icon); ?>'></i> <?php echo e($menu->name); ?> <span class='pull-right'><a class='fa fa-pencil' title='Edit' href='<?php echo e(route("MenusControllerGetEdit",["id"=>$menu->id])); ?>?return_url=<?php echo e(urlencode(Request::fullUrl())); ?>'></a>&nbsp;&nbsp;<a title='Delete' class='fa fa-trash' onclick='<?php echo e(CRUDBooster::deleteConfirm(route("MenusControllerGetDelete",["id"=>$menu->id]))); ?>' href='javascript:void(0)'></a></span></div>
                          <ul>
                            <?php if($menu->children): ?>
                              <?php $__currentLoopData = $menu->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li data-id='<?php echo e($child->id); ?>' data-name='<?php echo e($child->name); ?>'><div><i class='<?php echo e($child->icon); ?>'></i> <?php echo e($child->name); ?> <span class='pull-right'><a class='fa fa-pencil' title='Edit' href='<?php echo e(route("MenusControllerGetEdit",["id"=>$child->id])); ?>?return_url=<?php echo e(urlencode(Request::fullUrl())); ?>'></a>&nbsp;&nbsp;<a title="Delete" class='fa fa-trash' onclick='<?php echo e(CRUDBooster::deleteConfirm(route("MenusControllerGetDelete",["id"=>$child->id]))); ?>' href='javascript:void(0)'></a></span></div></li>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                          </ul>
                        </li>
