<?php $__env->startSection('content'); ?>
            ...
            <ul class='nav nav-tabs'>
                    <li style="background:#eeeeee"><a style="color:#111" onclick="if(confirm('Are you sure want to leave ?')) location.href='<?php echo e(CRUDBooster::mainpath("import-data")); ?>'" href='javascript:;'><i class='fa fa-download'></i> Upload a File &raquo;</a></li>
            ...
            <div id='box_main' class="box box-primary">
                    ...
                    <script type="text/javascript">
                      $(function() {
                        ...
                        var int_prog = setInterval(function() {
                          ...
                          $.post("<?php echo e(CRUDBooster::mainpath('do-import-chunk?file='.Request::get('file'))); ?>",{resume:1},function(resp) {                                       
                        ...
                        $.post("<?php echo e(CRUDBooster::mainpath('do-import-chunk').'?file='.Request::get('file')); ?>",function(resp) {
                            if(resp.status==true) {
                ...
                <div class="box-footer" id='upload-footer' style="display:none">  
                  <div class='pull-right'>                            
                      <a href='<?php echo e(CRUDBooster::mainpath("import-data")); ?>' class='btn btn-default'><i class='fa fa-upload'></i> Upload Other File</a> 
                      <a href='<?php echo e(CRUDBooster::mainpath()); ?>' class='btn btn-success'>Finish</a>                                
                  </div>
                </div><!-- /.box-footer-->
                ...
                <form method='post' id="form" enctype="multipart/form-data" action='<?php echo e($action); ?>'>
                        ...
                        <div class="box-body table-responsive no-padding">
                              ...
                              <table class='table table-bordered' style="width:130%">
                                  <thead>
                                      <tr class='success'>
                                          <?php $__currentLoopData = $table_columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            $help = ''; 
                                        ...
                                        <?php $__currentLoopData = $table_columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <td data-no-column='<?php echo e($k); ?>'>
                                                <select style='width:120px' class='form-control select_column' name='select_column[<?php echo e($k); ?>]'>
                                                    ...
                                                    <?php $__currentLoopData = $data_import_column; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $import_column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="box-footer">  
                          <div class='pull-right'>                            
                              <a onclick="if(confirm('Are you sure want to leave ?')) location.href='<?php echo e(CRUDBooster::mainpath("import-data")); ?>'" href='javascript:;' class='btn btn-default'>Cancel</a>  
            ...
            <ul class='nav nav-tabs'>
                    <li style="background:#ffffff" class='active'><a style="color:#111" onclick="if(confirm('Are you sure want to leave ?')) location.href='<?php echo e(CRUDBooster::mainpath("import-data")); ?>'" href='javascript:;'><i class='fa fa-download'></i> Upload a File &raquo;</a></li>
                    <li style="background:#eeeeee"><a style="color:#111" href='#'><i class='fa fa-cogs'></i> Adjustment &raquo;</a></li>
                    <li style="background:#eeeeee"><a style="color:#111" href='#'><i class='fa fa-cloud-download'></i> Importing &raquo;</a></li>
            </ul>
            ...
            <div id='box_main' class="box box-primary">
                ...
                <form method='post' id="form" enctype="multipart/form-data" action='<?php echo e($action); ?>'>
                        ...
                        <div class="box-footer">  
                          <div class='pull-right'>                            
                              <a href='<?php echo e(CRUDBooster::mainpath()); ?>' class='btn btn-default'>Cancel</a>  
