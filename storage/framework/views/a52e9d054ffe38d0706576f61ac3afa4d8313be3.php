...
?>
	<?php if(file_exists(base_path('/vendor/crocodicstudio/crudbooster/src/views/default/type_components/'.$type.'/asset.blade.php'))): ?>
		<?php echo $__env->make('crudbooster::default.type_components.'.$type.'.asset', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>  
	<?php elseif(file_exists(resource_path('views/vendor/crudbooster/type_components/'.$type.'/asset.blade.php'))): ?>
		<?php echo $__env->make('vendor.crudbooster.type_components.'.$type.'.asset', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>  
	<?php endif; ?>
<?php
	$asset_already[] = $type;
}
	...
	foreach($forms as $index=>$form) {
		...
		<?php if(file_exists(base_path('/vendor/crocodicstudio/crudbooster/src/views/default/type_components/'.$type.'/component.blade.php'))): ?>
			<?php echo $__env->make('crudbooster::default.type_components.'.$type.'.component', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		<?php elseif(file_exists(resource_path('views/vendor/crudbooster/type_components/'.$type.'/component.blade.php'))): ?>
			<?php echo $__env->make('vendor.crudbooster.type_components.'.$type.'.component', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		<?php else: ?>
