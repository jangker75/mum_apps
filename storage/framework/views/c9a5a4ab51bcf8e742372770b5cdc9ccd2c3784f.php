                ...
                <?php $__env->stopPush(); ?>
                  ...
                  <table id='table_dashboard' class="table table-hover table-striped table-bordered">
                    ...
                    <tr class="active">           
                      ...
                      <th width="1%"><?php echo e(trans('crudbooster.no')); ?></th>
                      <?php endif;?>
                      <?php                       
                    ...
                    <tbody>
                      ...
                      <tr class='warning'>
                          ...
                          <i class='fa fa-search'></i> <?php echo e(trans("crudbooster.table_data_not_found")); ?>
                      ...
                      <?php $__currentLoopData = $html_contents['html']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$hc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <?php endif; ?>
                              ...
                              <?php $__currentLoopData = $hc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td><?php echo $h; ?></td>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </tr>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div style="padding: 20px">
              <div class="row">
                <div class="col-sm-6">
                  <div style="padding:20px 0px 20px 0px">Found <?php echo e(number_format($totaldata)); ?> records</div>
            ...
            $(function(){
              ...
              $(".filter-combo").change(function() {                
                ...
                switch(n) {
                  ...
                  case 'like':
                  case 'not like':                                                              
                    filter_value.attr('placeholder','<?php echo e(trans("crudbooster.filter_eg")); ?> : <?php echo e(trans("crudbooster.filter_lorem_ipsum")); ?>').prop('disabled',false);
                  break;
                  case 'asc':                                        
                    filter_value.prop('disabled',true).attr('placeholder','<?php echo e(trans("crudbooster.filter_sort_ascending")); ?>');
                  break;
                  case 'desc':                                        
                    filter_value.prop('disabled',true).attr('placeholder','<?php echo e(trans("crudbooster.filter_sort_descending")); ?>');
                  break;
                  case '=':                                        
                    filter_value.prop('disabled',false).attr('placeholder','<?php echo e(trans("crudbooster.filter_eg")); ?> : <?php echo e(trans("crudbooster.filter_lorem_ipsum")); ?>');
                  break;
                  case '>=':                                                
                    filter_value.prop('disabled',false).attr('placeholder','<?php echo e(trans("crudbooster.filter_eg")); ?> : 1000');
                  break;
                  case '<=':                                                
                    filter_value.prop('disabled',false).attr('placeholder','<?php echo e(trans("crudbooster.filter_eg")); ?> : 1000');
                  break;
                  ...
                  break;
                  case 'in':                                        
                    filter_value.prop('disabled',false).attr('placeholder','<?php echo e(trans("crudbooster.filter_eg")); ?> : <?php echo e(trans("crudbooster.filter_lorem_ipsum_dolor_sit")); ?>');
                  break;
                  case 'not in':                                        
                    filter_value.prop('disabled',false).attr('placeholder','<?php echo e(trans("crudbooster.filter_eg")); ?> : <?php echo e(trans("crudbooster.filter_lorem_ipsum_dolor_sit")); ?>');
                  break;
                ...
                <div class="modal-content" >
                  ...
                  <form method='get' action=''>                    
                        ...
                        <div class='row-filter-combo row'>
                          ...
                          <div class='col-sm-3'>
                            <select name='filter_column[<?php echo e($col["field_with"]); ?>][type]' data-type='<?php echo e($col["type_data"]); ?>' class="filter-combo form-control">
                              <option value=''>** <?php echo e(trans("crudbooster.filter_select_operator_type")); ?></option>             
                              <?php if(in_array($col['type_data'],['string','varchar','text','char'])): ?><option <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == 'like')?"selected":""); ?> value='like'><?php echo e(trans("crudbooster.filter_like")); ?></option> <?php endif; ?>
                              <?php if(in_array($col['type_data'],['string','varchar','text','char'])): ?><option <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == 'not like')?"selected":""); ?> value='not like'><?php echo e(trans("crudbooster.filter_not_like")); ?></option><?php endif; ?>
                              
                              <option typeallow='all' <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == '=')?"selected":""); ?> value='='><?php echo e(trans("crudbooster.filter_equal_to")); ?></option>
                              <?php if(in_array($col['type_data'],['int','integer','double','float','decimal','time'])): ?><option <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == '>=')?"selected":""); ?> value='>='><?php echo e(trans("crudbooster.filter_greater_than_or_equal")); ?></option><?php endif; ?>
                              <?php if(in_array($col['type_data'],['int','integer','double','float','decimal','time'])): ?><option <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == '<=')?"selected":""); ?> value='<='><?php echo e(trans("crudbooster.filter_less_than_or_equal")); ?></option><?php endif; ?>
                              <?php if(in_array($col['type_data'],['int','integer','double','float','decimal','time'])): ?><option <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == '<')?"selected":""); ?> value='<'><?php echo e(trans("crudbooster.filter_less_than")); ?></option><?php endif; ?>
                              <?php if(in_array($col['type_data'],['int','integer','double','float','decimal','time'])): ?><option <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == '>')?"selected":""); ?> value='>'><?php echo e(trans("crudbooster.filter_greater_than")); ?></option><?php endif; ?>
                              <option typeallow='all' <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == '!=')?"selected":""); ?> value='!='><?php echo e(trans("crudbooster.filter_not_equal_to")); ?></option>
                              <option typeallow='all' <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == 'in')?"selected":""); ?> value='in'><?php echo e(trans("crudbooster.filter_in")); ?></option>
                              <option typeallow='all' <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == 'not in')?"selected":""); ?> value='not in'><?php echo e(trans("crudbooster.filter_not_in")); ?></option>
                              <?php if(in_array($col['type_data'],['date','time','datetime','int','integer','double','float','decimal','timestamp'])): ?><option <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == 'between')?"selected":""); ?> value='between'><?php echo e(trans("crudbooster.filter_between")); ?></option><?php endif; ?>                         
                              <option <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == 'empty')?"selected":""); ?> value='empty'>Empty ( or Null)</option>
                            </select>
                          </div><!--END COL_SM_4-->
                          ...
                          <div class='col-sm-5'>
                            <input type='text' class='filter-value form-control' style="<?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == 'between')?"display:none":"display:block"); ?>" disabled name='filter_column[<?php echo e($col["field_with"]); ?>][value]' value='<?php echo e((!is_array(CRUDBooster::getValueFilter($col["field_with"])))?CRUDBooster::getValueFilter($col["field_with"]):""); ?>'>
                            ...
                            <div class='row between-group' style="<?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == 'between')?"display:block":"display:none"); ?>">
                              <div class='col-sm-6'>
                                <div class='input-group <?php echo e(($col["type_data"] == "time")?"bootstrap-timepicker":""); ?>'>
                                  <span class="input-group-addon"><?php echo e(trans("crudbooster.filter_from")); ?>:</span>
                                  <input 
                                  <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) != 'between')?"disabled":""); ?>

                                  type='text' 
                                  class='filter-value-between form-control <?php echo e((in_array($col["type_data"],["date","datetime","timestamp"]))?"datepicker":"timepicker"); ?>' readonly placeholder='<?php echo e($col["label"]); ?> <?php echo e(trans("crudbooster.filter_from")); ?>' name='filter_column[<?php echo e($col["field_with"]); ?>][value][]' value='<?php
                              ...
                              <div class='col-sm-6'>
                                <div class='input-group <?php echo e(($col["type_data"] == "time")?"bootstrap-timepicker":""); ?>'>
                                  <span class="input-group-addon"><?php echo e(trans("crudbooster.filter_to")); ?>:</span>
                                  <input 
                                  <?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) != 'between')?"disabled":""); ?>

                                  type='text' 
                                  class='filter-value-between form-control <?php echo e((in_array($col["type_data"],["date","datetime","timestamp"]))?"datepicker":"timepicker"); ?>' readonly placeholder='<?php echo e($col["label"]); ?> <?php echo e(trans("crudbooster.filter_to")); ?>' name='filter_column[<?php echo e($col["field_with"]); ?>][value][]' value='<?php
                                  $value = CRUDBooster::getValueFilter($col["field_with"]); 
                          ...
                          <div class='col-sm-2'>
                              <select class='form-control' name='filter_column[<?php echo e($col["field_with"]); ?>][sorting]'>
                                  ...
                                  <option <?php echo e((CRUDBooster::getSortingFilter($col["field_with"]) == 'asc')?"selected":""); ?> value='asc'><?php echo e(trans("crudbooster.filter_ascending")); ?></option>
                                  <option <?php echo e((CRUDBooster::getSortingFilter($col["field_with"]) == 'desc')?"selected":""); ?> value='desc'><?php echo e(trans("crudbooster.filter_descending")); ?></option>
                              </select>
                          </div><!--END_COL_SM_2-->
                    ...
                    <div class="modal-footer" align="right">
                      ...
                      <button class="btn btn-default btn-reset" type="reset" onclick='location.href="<?php echo e(Request::get("lasturl")); ?>"' ><?php echo e(trans("crudbooster.button_reset")); ?></button>
