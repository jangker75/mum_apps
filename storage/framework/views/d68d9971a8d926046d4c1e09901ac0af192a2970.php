	...
	<script type="text/javascript">
		...
		function addSoal() {
			...
			var html = "<table id='soal"+lastNo+"' data-no='"+lastNo+"' class='table table-striped table-soal'>";
				...
				html += '<tr><td>Keterangan #'+lastNo+'</td><td>:</td><td><input type="text" class="form-control" name="keterangan['+lastNo+']"  ></td></tr>';
				html += '<tr><td>Urutan #'+lastNo+'</td><td>:</td><td><input style="width: 150px" type="number" class="form-control" name="urutan['+lastNo+']" required ></td></tr>';
				html += '<tr><td>Tipe #'+lastNo+'</td><td>:</td><td><select class=\'form-control\' name=\'tipe['+lastNo+']\' required >'+
					 '<option value="Radio">Radio</option>'+
					 '<option value="Checkbox">Checkbox</option>'+ 
					 '<option value="Text">Text</option>'+
					 '<option value="Upload Image">Upload Image</option></select></td></tr>';
				html += '<tr><td>Jumlah Upload #'+lastNo+'</td><td>:</td><td><input type="number" style="width: 150px" class="form-control" name="jumlah_upload['+lastNo+']" ></td></tr>';
	...
	<div class="panel-body panel-body-soal">
		...
		<table id='soal1' data-no='1' class="table table-striped table-soal">
			<tbody>
				...
				<tr><td>Keterangan #1</td><td>:</td><td><input type="text" class="form-control" name="keterangan[1]" required ></td></tr>
				<tr><td>Urutan #1</td><td>:</td><td><input type="number" style="width: 150px" class="form-control" name="urutan[1]" required ></td></tr>
				<tr><td>Tipe #1</td><td>:</td><td><select class='form-control' name='tipe[1]' required >
					<option value="Radio">Radio</option>
					<option value="Checkbox">Checkbox</option>
					<option value="Text">Text</option>
				...
				<tr><td>Jumlah Upload #1</td><td>:</td><td><input type="number" style="width: 150px" class="form-control" name="jumlah_upload[1]" ></td></tr>
